...
const services = [
  {
    ...
    description: "Murphy beds and custom cabinetry that maximize space and style.",
    link: "#learn-more"
  },
  {
    icon: <HiLightBulb className="w-8 h-8 text-amber-400" />,
    title: "Lighting Design",
    description: "Voice-controlled ambient lighting for mood, function, and flair.",
    link: "#learn-more"
  },
  {
    icon: <FiSettings className="w-8 h-8 text-red-400" />,
    title: "AI Mirror Control",
    description: "A smart mirror that listens, responds, and controls your room.",
    link: "#learn-more"
  },
  {
    icon: <BiTime className="w-8 h-8 text-cyan-400" />,
    title: "Custom Finishes",
    description: "Personalized paint and textures — made to match your vision.",
    link: "#learn-more"
  }
]
...
export default function ServiceSection() {
  return (
    <motion.section 
      ...
      id="services"
      className="w-full bg-[#eff9fb] py-20"
    >
      {/* Container keeps content centered but background stays full width */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            >
              Complete Smart Room Solutions
            </motion.h2>
            <motion.p 
              variants={fadeIn('up', 0.5)}
              className="text-gray-600 text-lg mb-4 md:w-4/5"
            >
              We combine functionality with high-end design to transform your room into a smart, responsive living space.
            </motion.p>
            ...
            <motion.div variants={fadeIn('up', 0.6)} className="space-y-3">
              <motion.div variants={fadeIn('right', 0.7)} className="flex items-center gap-2">
                ...
                <span className="text-gray-600">Custom-fit installations</span>
              </motion.div>
              ...
              <motion.div variants={fadeIn('right', 0.8)} className="flex items-center gap-2">
                ...
                <span className="text-gray-600">Voice and AI-powered automation</span>
              </motion.div>
            </motion.div>
